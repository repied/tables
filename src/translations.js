window.translations = {
    fr: {
        ...
        "interval-title": "Durée intervalle de surface (min)",
        secondDive: "Seconde plongée",
        time: "Temps",
        "time-title": "Durée (min), descente + temps au fond",
        depth: "Profondeur",
        "depth-title": "Profondeur maximale (m)",
        pressure: "Pression",
        "pressure-title": "Pression bouteille (bar)",
        sac: "Conso",
        "sac-title": "Consommation d'air en surface",
        volume: "Volume",
        "volume-title": "Volume bouteille (L)",
        o2: "O2",
        "o2-title": "Mélange Oxygène (%)",
        "gf-low": "GF Bas",
        ...
        donate: "💶",
        help: "Aide",
        helpIntro: "Application gratuite et open source pour planifier des plongées loisir en utilisant soit les tables MN90 de la Marine Nationale, soit l'algorithme Bühlmann ZHL-16C avec Facteurs de Gradient. Les dons sont les bienvenus pour soutenir le développement.",
        helpTitle: "Utilisation des gauges",
        ...
        usage5: "<strong>Calculs :</strong> DTR (Durée Totale de Remontée) et Pression de réserve.",
        usage6: "<strong>Alertes :</strong> Réserve < 50b (rouge), ppO2 > 1.5 (orange).",
        usage7: "",
        calcTitle: "Hypothèses de calcul",
        calc1: "<strong>Altitude :</strong> niveau de la mer, eau salée",
    ...
    en: {
        ...
        "interval-title": "Surface Interval Duration (min)",
        secondDive: "Second dive",
        time: "Time",
        "time-title": "Dive Duration (min), descent + bottom time",
        depth: "Depth",
        "depth-title": "Maximum Depth (m)",
        pressure: "Pressure",
        "pressure-title": "Tank Pressure (bar)",
        sac: "SAC",
        "sac-title": "Surface Air Consumption",
        volume: "Volume",
        "volume-title": "Tank Volume (L)",
        o2: "O2",
        "o2-title": "Oxygen Percentage (%)",
        "gf-low": "GF Low",
        ...
        donate: "💵",
        help: "Help",
        helpIntro: "A free and open source App for planning non-technical dives using either French Navy MN90 tables or Bühlmann ZHL-16C with Gradient Factors. Donations welcomed to support development costs.",
        helpTitle: "Usage of the gauges",
        ...
        usage5: "<strong>Calculations:</strong> TTS (Time To Surface) and Reserve Pressure.",
        usage6: "<strong>Alerts:</strong> Reserve < 50b (red), ppO2 > 1.5 (orange).",
        usage7: "",
        calcTitle: "Calculation assumptions",
        calc1: "<strong>Altitude:</strong> sea level, with seawater",
