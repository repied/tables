window.translations = {
    ...
    en: {
        ...
        usage5: "The Successive Dive Group (SDG, in <strong>MN90</strong> mode) or the residual supersaturation of the compartments (in <strong>GF</strong> mode) is used for the second dive.",
