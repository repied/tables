window.translations = {
    fr: {
        ...
        usage7: "",
        shareTitle: "Partage",
        sharePlan: "Générer un QR Code",
        importPlan: "Importer un plan",
        shareModalTitle: "Partager le plan",
        shareLinkText: "Lien de partage :",
        copyLink: "Copier le lien",
        scanModalTitle: "Scanner un plan",
        scanStatusWaiting: "Attente de la caméra...",
        scanStatusScanning: "Scan en cours...",
        scanStatusError: "Erreur d'accès à la caméra",
        cancel: "Annuler",
        planImported: "Plan importé avec succès !",
        invalidPlan: "Code QR invalide",
    ...
    en: {
        ...
        usage7: "",
        shareTitle: "Sharing",
        sharePlan: "Generate QR Code",
        importPlan: "Import a Plan",
        shareModalTitle: "Share Plan",
        shareLinkText: "Shareable link:",
        copyLink: "Copy Link",
        scanModalTitle: "Scan a Plan",
        scanStatusWaiting: "Waiting for camera...",
        scanStatusScanning: "Scanning...",
        scanStatusError: "Camera access error",
        cancel: "Cancel",
        planImported: "Plan imported successfully!",
        invalidPlan: "Invalid QR code",
